...
class Category_share extends M_Controller {
    ...
    protected function _get_tree($data) {
        ...
        foreach($data as $t) {
            ...
            // 可操作的权限判断
            $t['tid'] == 1 && $this->is_auth('admin/field/index') && $t['option'].= '<a class="alist onloading" href='.$this->duri->uri2url('admin/field/index/rname/share-'.SITE_ID.'/rid/'.$t['id']).'> <i class="fa fa-plus-square"></i> '.fc_lang('附加字段').'('.(int)count($category[$t['id']]['field']).')</a>';
