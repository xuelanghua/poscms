...
class WxprojectSlide extends M_Controller {
    ...
    public function __construct() {
        ...
        $this->template->assign(array(
            'menu' => $this->get_menu_v3(array(
                fc_lang('幻灯片列表') => array('admin/wxprojectSlide/slide_list', 'file-movie-o'),
                fc_lang('添加幻灯片') => array('admin/wxprojectSlide/slide_add', 'plus'),
