        ...
        <div class="portlet-title tabbable-line">
            ...
            <ul class="nav nav-tabs" style="float:left;">
                ...
                <li class="<?php if ($page==7) { ?>active<?php } ?>">
                    <a href="#tab_7" data-toggle="tab" onclick="$('#mypage').val('7')"> <i class="fa fa-picture-o"></i> <?php echo fc_lang('图片缩略图'); ?> </a>
                </li>
                <li class="<?php if ($page==5) { ?>active<?php } ?>">
                    <a href="#tab_5" data-toggle="tab" onclick="$('#mypage').val('5')"> <i class="fa fa-tint"></i> <?php echo fc_lang('自定义链接名称'); ?> </a>
                </li>
            </ul>
        </div>
            ...
            <div class="tab-content">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                ...
                                <span class="help-block"><?php echo fc_lang('例如：POSCMS官方站'); ?></span>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                ...
                                <?php } else { ?>
                                <span class="help-block" id="dr_domain_tips"><?php echo fc_lang('例如：POSCMS官方站'); ?></span>
                                <?php } ?>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <label>
                                    <select class="form-control" name="data[SITE_REWRITE]">
                                        ...
                                        <?php $return_u = $this->list_tag("action=cache name=urlrule  return=u"); if ($return_u) extract($return_u); $count_u=count($return_u); if (is_array($return_u)) { foreach ($return_u as $key_u=>$u) {  if ($u['type']==4) { ?><option value="<?php echo $u['id']; ?>" <?php if ($u['id']==$data['SITE_REWRITE']) { ?>selected<?php } ?>> <?php echo $u['name']; ?> </option><?php }  } } ?>
                                    </select>
                                </label>
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label"><?php echo fc_lang('站点路径Beta'); ?>：</label>
                            <div class="col-md-9">
                                <input class="form-control" type="text" name="data[SITE_WWW]" value="<?php echo $data['SITE_WWW']; ?>">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                ...
                                <span id="dr_mb_domian" class="help-block"></span>
                                <?php } else { ?>
                                <span class="help-block"><?php echo fc_lang('格式：test.dayrui.com'); ?></span>
                                <?php } ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 control-label"><?php echo fc_lang('移动端模板'); ?>：</label>
                            <div class="col-md-9">
                                <div class="form-control-static"><label><?php echo fc_lang('绑定域名之后必须制作移动端模板'); ?></label></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-pane  <?php if ($page==7) { ?>active<?php } ?>" id="tab_7">
                    ...
                    <div class="form-body">
                        ...
                        <?php for ($i = 1; $i <= 9; $i ++) { ?>
                        <div class="form-group">
                            <label class="col-md-2 control-label"><?php echo fc_lang('参数(%s)', $i); ?>：</label>
                            <div class="col-md-9">
                                <label><input class="form-control input-xsmall" type="text" name="data[image][<?php echo $i; ?>][width]" value="<?php echo $data['image'][$i]['width']; ?>" /></label>
                                <label><i class="fa fa-times"></i></label>
                                <label style="margin-right: 10px"><input class="form-control input-xsmall" type="text" name="data[image][<?php echo $i; ?>][height]" value="<?php echo $data['image'][$i]['height']; ?>" /> </label>
                                <label><input type="checkbox" name="data[image][<?php echo $i; ?>][crop]" <?php if ($data['image'][$i]['crop']) { ?>checked<?php } ?> value="1"></label>
                                <label><?php echo fc_lang('裁剪缩略图'); ?></label>
                            </div>
                        </div>
                        <?php } ?>
                        <div class="alert alert-info">
                            <?php echo fc_lang('上传图片时会按照以上配置来生成对应尺寸的文件, 前端代码可以使用dr_image函数调用对应的图片'); ?>
                        </div>
