...
<head>
    ...
    <link href="<?php echo THEME_PATH; ?>admin/layouts/layout/css/themes/light2.min.css" rel="stylesheet" type="text/css" id="style_color">
    <link href="<?php echo THEME_PATH; ?>admin/layouts/layout/css/custom.min.css" rel="stylesheet" type="text/css" />
...
<div class="tab-content">
    ...
    <div class="tab-pane glyphicons-demo" id="tab_1_2">
        <div class="note note-success">
            ...
            <a href="http://getbootstrap.com/components/#glyphicons" target="_blank">http://getbootstrap.com/components/#glyphicons</a>
        </div>
