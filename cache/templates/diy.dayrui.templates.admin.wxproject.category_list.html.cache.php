    ...
    <div class="portlet-body">
        <div class="table-scrollable">
            ...
            <tr>
                ...
                <th class="text-center"><?php echo fc_lang('排序'); ?></th>
                <th class="text-center">Id</th>
                <th class="text-center"><?php echo fc_lang('产品分类名称'); ?></th>
                <th class="text-center"><?php echo fc_lang('状态'); ?></th>
                <th class="text-center col-md-3 dr_option"><?php echo fc_lang('操作'); ?></th>
            </tr>
            </thead>
            <tbody>
            <?php echo $list; ?>
            <tr class="mtable_bottom">
                ...
                <td colspan="99"  >
                <?php if ($this->ci->is_auth('wxprojectCategory/del')) { ?><button data-toggle="confirmation" id="dr_confirm_set_all" data-original-title="<?php echo fc_lang('您确定要这样操作吗？'); ?>" type="button" class="btn red btn-sm" name="option"> <i class="fa fa-trash"></i> <?php echo fc_lang('删除'); ?></button><?php }  if ($this->ci->is_auth('wxprojectCategory/edit')) { ?><button data-toggle="confirmation" id="dr_confirm_order" data-original-title="<?php echo fc_lang('排序按从小到大排列，最大支持99'); ?>" type="button" class="btn green btn-sm" name="option"> <i class="fa fa-edit"></i> <?php echo fc_lang('排序'); ?></button><?php } ?>
                </td>
            </tr>
            </tbody>
            </table>
